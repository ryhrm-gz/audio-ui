...
export function LevelMeterDemo() {
  ...
  return (
    <div className={styles.root} data-variant="level-meter">
      <div className={styles.meterConsole}>
        <div className={styles.meterHeader}>
          <span className={styles.label}>Stereo level</span>
          <button
        ...
        >
          ...
          <LevelMeter.Track className={styles.levelMeterTrack}>
            ...
            <LevelMeter.Bar channel={0} className={styles.levelMeterBar}>
              <LevelMeter.Segments channel={0} className={styles.levelMeterBarSegments} />
            </LevelMeter.Bar>
            <LevelMeter.Peak channel={0} className={styles.levelMeterPeak} />
            <LevelMeter.Bar channel={1} className={styles.levelMeterBar}>
              <LevelMeter.Segments channel={1} className={styles.levelMeterBarSegments} />
            </LevelMeter.Bar>
            <LevelMeter.Peak channel={1} className={styles.levelMeterPeak} />
          </LevelMeter.Track>
